...
namespace ApartmentAgencyApp.Fakes
{
    ...
    {
        private readonly List<Apartment> _availableApartment;

        public FakeApartmentService(List<Apartment> availableApartment)
        {
            _availableApartment = availableApartment;
        }
        public List<Apartment> GetAvailableApartments(ReservationRequest request)
        {
            return _availableApartment;
        }
    }
}
